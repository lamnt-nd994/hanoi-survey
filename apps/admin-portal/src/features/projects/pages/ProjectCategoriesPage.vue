<template>
  <PageShell>
    <PageHeader title="Danh mục dự án" description="Quản lý nhóm danh mục dùng để phân loại dự án trên website." />
        ...
        <Table>
          ...
          <TableBody>
            ...
            <TableRow v-if="!store.categories.length">
              <TableCell colspan="5" class="h-32 text-center text-slate-400">Chưa có danh mục dự án.</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </DataCard>
