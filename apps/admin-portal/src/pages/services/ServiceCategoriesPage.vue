<template>
  <div>
    <PageHeader title="Danh mục dịch vụ" description="Quản lý nhóm danh mục dùng để phân loại dịch vụ trên website." />
          ...
          <table class="min-w-full divide-y divide-slate-200 text-sm">
            ...
            <tbody class="divide-y divide-slate-100 bg-white text-slate-700">
              ...
              <tr v-if="!store.categories.length">
                <td colspan="5" class="px-4 py-10 text-center text-slate-400">Chưa có danh mục dịch vụ.</td>
              </tr>
            </tbody>
          </table>
        </div>
