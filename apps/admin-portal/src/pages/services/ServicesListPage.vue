    ...
    <div class="cms-card mt-6">
      <div class="cms-table-wrap">
        <table class="cms-table">
          <thead><tr><th>Tên dịch vụ</th><th>Slug</th><th>Trạng thái</th><th style="width:100px">Thao tác</th></tr></thead>
          <tbody>
            ...
            <tr v-if="!store.items.length"><td colspan="4" style="text-align:center;padding:40px;color:#9ca3af">Chưa có dữ liệu</td></tr>
          </tbody>
        </table>
      </div>
    </div>
