...
function createEmptyHomeContent(): HomePageContent {
  return {
    ...
    servicesSection: {
      ...
      limit: 6,
      selectedItems: [
        { serviceId: 11, categoryId: 2, icon: 'map-marked-alt' },
        { serviceId: 13, categoryId: 1, icon: 'globe-asia' },
        { serviceId: 14, categoryId: 4, icon: 'flask' },
        { serviceId: 16, categoryId: null, icon: 'hard-hat' },
        { serviceId: 12, categoryId: null, icon: 'water' },
        { serviceId: 15, categoryId: null, icon: 'chart-line' },
      ],
    },
    projectsSection: {
      eyebrow: 'Dự án',
